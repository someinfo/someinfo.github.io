...
I know what you're thinking. Yes, I could've made this a whole lot shorter by featuring less screenshots and jumping straight to the point. However, the story you're about to read, my dear bustabit readers, is full of twists and revelations, and to maximize your enjoyment, I believe that providing context is a necessity. For the same reason, I also don't intend to provide you with a summary of what you're about to read, as I believe it would spoil the surprise, to an extent.
...
```
It makes perfect sense that he would think so. After all, StackGod2's message to him right before the mute was *“@TekDek lol fuck this, this is already getting out of hand, **he’s been baiting people in chat nonstop for days**; You need to mute him right the fuck now.”* It seems like he is *still* under the impression that the guy got baited and was not an existing offender, which is idiotic, given that the very first screenshot on this page shows Lehxus blatantly begging, and I also posted the screenshot in chat, again, minutes before TekDek's message. 

Also, as I had been saying up to that point (and as can be seen in the screenshot) — the mute took place ~68 minutes after the ralnon, so it is more than likely that he had not seen it and/or the begging that preceded it, but as I previously mentioned, we'll revisit that point later. For now, let's focus on the nonexistent warnings. 
...
Have I been warned by TekDek multiple times not to fake rain in the days/month leading up to the mute?
...
```
He ended up pleasing his master within 20 hours after that message. 🤡
...
Nope; it was concerning copy pastas. We could move on, but I believe that showing how the whole thing played out could provide some valuable insight:

I didn't complain about the warning, and did not paste any other pasta. [However, vehtje chose to ignore the warning, proceeded to paste 3 more, and TekDek muted him. Keep in mind that mute notifications don't show up in the chat logs, and the rest of the messages leave no room for doubt](https://i.imgur.com/OMjLYNn.png) (I again emitted much of the irrelevant chatter in-between, to make the screenshot shorter). About 7 minutes later, [shadow2poor posted a funny roast, so I asked TekDek if he was going to mute me if I replied](https://i.imgur.com/WnFkStn.png). As you can see, he replied that he would, and added that I should have gotten muted along with vehtje. How does it make sense, when I barely pasted a single copy pasta, *before the warning*, and did not post another copy pasta, afterwards? [I think scrolling up made him realize that he was tripping, so this time he didn't double down and probably acknowledge the fact that claiming I should have gotten muted along with vehtje was a stretch. He then proceeded to unmute vehtje, *"to be fair."*](https://i.imgur.com/eJWnbtS.png) No clue if it had anything to do with our argument or because his master was protesting the mute, as I had not argued the mute on vehtje was unjustified.
...
15. ```
   ...
   ```
   ❗ **Remarks:** On February 6 (chapter II) I did mention (as shown in the screenshot) that I had only done a couple public rains and that TekDek wasn't even around to see them. I obviously don't need to justify an occasional fake public rain, as it's clearly okay to do it sparingly, and people do that in front of TekDek all the time. Even so, I resumed reading the chat logs and found the context rather interesting: ragz faked a public rain, we told him it was a shitty attempt, and I then said that I didn't want to do one because then people would try to get me muted for it (showing that I clearly think there is a distinction between public fake rain and a direct fake rain on beggars, given that I had yet to be warned for it), but I eventually did. [I also only "rained" on people who are clearly in on the joke, and are well aware that I'm trolling](https://i.imgur.com/2A6slNi.png).
...
3. `2022-11-18 12:31:48	TekDek	thats your second fake rain`:
   ...
   I wasn't even active in chat at the time. Apparently, Merimakichut was taking advantage of the hype in chat, as GodzillaVsKong had been legitimately raining, and faked rains in order to get random people's hopes up. Seems like everybody wanted him gone, and justifiably so; there's a clear distinction between this kind of rains and mine.

-------------

I also went ahead and filtered all chat logs that contain the keyword `TekDek` for just `stop`, and even that didn't bring anything worth mentioning. 
...
This is what I wrote — almost verbatim — to all three mods (Daniel, RabbitMilk and AppleGuy), and it was long before I got my hands on the chat logs.
...
Even with both public rain instances (!rain 3 500) included, we arrive at a total of 21 rains in the span of 31 days — 0.6774 rains a day, on average. 
...
Not a *single* time, unless we count [this](https://i.imgur.com/jd4acQr.png). 🤡
...
Surely, you will prove to us all that there is still a shred of dignity left in you by stepping down from moderation, as you said you would. 
