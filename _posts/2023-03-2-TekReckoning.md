...
I didn't complain about the warning, and did not paste any other pasta. [However, vehtje chose to ignore the warning, proceeded to paste 3 more, and TekDek muted him. Keep in mind that mute notifications don't show up in the chat logs, and the rest of the messages leave no room for doubt](https://i.imgur.com/OMjLYNn.png) (I again emitted much of the irrelevant chatter in-between, to make the screenshot shorter). About 7 minutes later, [shadow2poor posted a funny roast, so I asked TekDek if he was going to mute me if I replied](https://i.imgur.com/WnFkStn.png). As you can see, he replied that he would, and added that I should have gotten muted along with vehtje. How does it make sense, when I barely pasted a single copy pasta, *before the warning*, and did not post another copy pasta, afterwards? [I assume scrolling up made him realize that he was tripping, so this time, he didn't double down and probably acknowledged the fact that claiming I should have gotten muted along with vehtje was a stretch. He then proceeded to unmute vehtje, *"to be fair."*](https://i.imgur.com/eJWnbtS.png) No clue if it had anything to do with our argument or because his master was protesting the mute, as I had not argued that the mute on vehtje was unjustified.
