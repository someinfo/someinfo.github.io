...
For your convenience, I have omitted most of the irrelevant chatter, making the screenshots a lot shorter than they otherwise would have been, so that you wouldn't be inclined to skip. I believe the discussion (if I can even call it that) was entertaining enough to warrant a thorough read, but I still highlighted most of the important bits with some commentary.
...
TekDek insisted about 9 times — during that conversation alone — that he had warned me against faking rain (on beggars or in general) *"at least 5 times or more"*, just *"days"* before the mute.
...
I didn't complain about the warning, and did not post additional ones. [However, vehtje chose to ignore the warning, proceeded to post 3 more, and TekDek muted him. Keep in mind that mute notifications don't show up in the chat logs, and the rest of the messages leave no room for doubt](https://i.imgur.com/OMjLYNn.png) (I again omitted much of the irrelevant chatter in-between, to make the screenshot shorter). About 7 minutes later, [shadow2poor posted a funny roast, so I asked TekDek if he was going to mute me if I replied](https://i.imgur.com/WnFkStn.png). As you can see, he replied that he would, and added that I should have gotten muted along with vehtje. How does it make sense, when I barely posted a single copypasta, *before the warning*, and did not post another copypasta, afterwards? [I assume scrolling up made him realize that he was tripping, so this time, he didn't double down and probably acknowledged the fact that claiming I should have gotten muted along with vehtje was a stretch. He then proceeded to unmute vehtje, *"to be fair."*](https://i.imgur.com/eJWnbtS.png) No clue if it had anything to do with our argument or because his master was protesting the mute, as I had not argued that the mute on vehtje was unjustified.

I was warned and did not post any additional copypastas. when I did wish to post one, I first asked TekDek, to make sure that it would be okay, and even though I was told that I'd *"probably"* get muted for it and I felt like it was bullshit, I still heeded the warning. **I clearly know better than to test a delusional mod on a power trip. If so, how does it make sense that I'd go on to fake rain even after I had been warned (allegedly) 5+ times within days prior to the day of the mute, according to TekDek?** Alas, we carry on.
...
So, let's examine every single `!rain/on`and `!raLnon` entry, just to alleviate any and all doubt. That might also help us examine a variety of other claims that have been made by both TekDek and I. 
...
**EDIT:**
Earlier today I dropped by chat and was too tempted to address TekDek's remarks. I'll include the screenshot for your enjoyment. I omitted off-topic messages (and thankfully, there weren't many):
